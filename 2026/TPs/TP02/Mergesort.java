...
class MergeSort {
    ...
    private static void mergeSort(Restaurante[] arr, int esq, int dir,
                                  Restaurante[] aux) {
        if (esq >= dir) return;
        int meio = (esq + dir) / 2;
        mergeSort(arr, esq,    meio, aux);
        mergeSort(arr, meio+1, dir,  aux);
        merge(arr, esq, meio, dir, aux);
    }
...
public class Mergesort {
    ...
    public static void main(String[] args) throws IOException {
        ...
        MergeSort.sort(lista, nLista, comparacoes, movimentacoes);
        ...
        FileWriter log = new FileWriter("885948_mergesort.txt");
        log.write(String.format("885948\t%d\t%d\t%.2f%n",

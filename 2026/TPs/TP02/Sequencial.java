...
class PesquisaSequencial {
    public static boolean pesquisar(Restaurante[] arr, int n,
                                    String nome, long[] comparacoes) {
        for (int i = 0; i < n; i++) {
            comparacoes[0]++;
...
public class Sequencial {
    ...
    public static void main(String[] args) throws IOException {
        ...
        Restaurante[] base   = new Restaurante[2000];
        int           nBase  = 0;
        ...
        while (sc.hasNextLine()) {
            ...
            boolean achou = PesquisaSequencial.pesquisar(base, nBase, linha, comparacoes);
        ...
        double tempoMs = tempoTotal / 1e6;
        FileWriter log = new FileWriter("885948_sequencial.txt");
        log.write(String.format("885948\t%d\t%.2f%n", comparacoes[0], tempoMs));
        log.close();
    }
}